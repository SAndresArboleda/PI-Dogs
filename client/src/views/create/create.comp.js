...
function Create() {
  ...
  // const Altura = height.metric
  // const Peso = weight.metric
  // const vida = life_span
  ...
  return (
    <div className="home">
      ...
      <form onSubmit={""} >
        ...
        <div>
          <label>Altura: </label>
          <input name="altura" value={input.value} onChange={handleChange} />
        </div>
        <div>
          <label>Peso: </label>
          <input name="peso" value={input.value} onChange={handleChange} />
        </div>
        <div>
          <label>Vida: </label>
          <input name="años" value={input.value} onChange={handleChange} />
        </div>
        <div>
